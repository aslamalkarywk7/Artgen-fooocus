...
#  فئات مختلفة للجداول الزمنية المخصصة وأجهزة أخذ العينات المستخدمة في سياق النماذج القائمة على الانتشار، وخاصة في سياق تقنيات توليد الصور وأخذ العينات. تمكن هذه الفئات المستخدمين من تكوين طرق مختلفة للجدولة وأخذ العينات لتوليد الصور استنادًا إلى قيم سيجما والمعلمات الأخرى. فيما يلي شرح موجز لما تفعله بعض هذه الفئات:

# BasicScheduler، KarrasScheduler، ExponentialScheduler، PolyexponentialScheduler، SDTurboScheduler، VPScheduler :

# هذه هي أنواع مختلفة من المجدولين الذين يتحكمون في "سيجما" التدريجية (مستويات الضوضاء) المستخدمة أثناء عملية إنشاء الصورة.
# تعيد الطريقة get_sigmasفي كل فئة سلسلة من قيم سيجما التي يتم تمريرها إلى النموذج أثناء التوليد.
# يختلف المجدولون في كيفية حساب هذه السيجما (كاراس، الأسي، متعدد الأس، وما إلى ذلك).
# SplitSigmas وFlipSigmas :

# هذه هي فئات المرافق لمعالجة قيم سيجما، مثل تقسيمها في خطوة معينة أو قلب تسلسل سيجما.
# KSamplerSelect :

# توفر هذه الفئة طريقة لتحديد أنواع مختلفة من العينات استنادًا إلى الاسم المقدم (مثل عينات DPM++).
# SamplerDPMPP_2M_SDE، SamplerDPMPP_SDE، SamplerTCD، SamplerCustom :

# هذه هي العينات المستخدمة أثناء عملية إنشاء الصورة.
# يحتوي كل جهاز أخذ عينات على تكوينات مختلفة مثل etaو s_noiseو واختيار الجهاز (وحدة معالجة الرسومات أو وحدة المعالجة المركزية) للتحكم في كيفية تطبيق الضوضاء أثناء أخذ العينات.
# تُعد هذه الفئات والوظائف ضرورية لتخصيص عملية إنشاء الصور والتحكم في استراتيجيات أخذ العينات المستخدمة في نماذج الانتشار الكامن (LDM)
